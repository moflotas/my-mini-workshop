...
namespace Modules.Sport.Infrastructure.Migrations
{
    ...
    [Migration("20240624142632_Initial")]
            ...
            modelBuilder.Entity("BuildingBlocks.Infrastructure.InternalCommands.InternalCommand", b =>
                {
                    ...
                    b.ToTable("InternalCommand", "Sport");
                });
            ...
            modelBuilder.Entity("BuildingBlocks.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessage", "Sport");
                });

            modelBuilder.Entity("Modules.Sport.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
